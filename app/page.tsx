    ...
    <>
      <MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center 
        ...
        <div className='mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 
                        ...
                        py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 
                        hover:bg-white/50'>
              <p className='text-sm font-semibold text-gray-700'>
                SmartDoc is now public!
              </p>
        </div>
        ...
        <p className='mt-5 max-w-prose text-zinc-700 sm:text-lg'>
              SmartDoc allows you to have conversations with any
        ...
        <ol className='my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0'>
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                It&apos;s that simple. Try out SmartDoc today -
